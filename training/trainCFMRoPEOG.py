...
from models.dit_RoPE_original import TrajectoryDiT    # CHANGED: RoPE-A model
...
def train(
    nc_path,
    output_dir   = "checkpoints_rope_a",    # CHANGED: separate checkpoint dir
    epochs       = 100,
    batch_size   = 64,
    lr           = 1e-4,
    weight_decay = 0.01,
    ...
    print(f"Training on {device} — RoPE-A (token index positions)")

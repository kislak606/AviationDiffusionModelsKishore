...
from models.KEVIN_DiT import TrajectoryDiT
...
def train(
    nc_path,
    output_dir   = "checkpoints_cfm_kevin_dit",
    epochs       = 100,
    batch_size   = 64,
    lr           = 1e-4,
    weight_decay = 0.01,
    ...
    print(f"Training on {device} — CFM + KEVIN_DiT")
...
if __name__ == "__main__":
    train(
        nc_path    = r"C:\dev\work\AviationDiffusionModelsKishore\trajectories_adsblol_seq86_stage2.nc",
        output_dir = "checkpoints_cfm_kevin_dit",
        epochs     = 100,
        batch_size = 64,
        d_model    = 256,
